...
False suspense transitions that promise a revelation but deliver a point that did not need the buildup. The model manufactures drama before an otherwise unremarkable observation.

Also includes: "Here's the thing", "Here's where it gets interesting", "Here's what most people miss".
...
Fix: Explain the actual thing. If a metaphor genuinely helps, use it without the "think of it as" framing.
...
Fix: Describe what exists or what you're proposing. Skip the hypothetical daydream.
...
Fix: If you have a bias, show it through your arguments. Don't announce it for credibility points.

## "The Truth Is Simple"

Asserting that something is obvious, clear or simple instead of proving it. If you have to tell the reader your point is clear, it probably isn't.
...
Fix: Present the evidence. Let the reader decide if it's clear.
...
Fix: Match your language to the actual stakes. Most things are incremental improvements, and that's fine.
...
Also includes: "Let's unpack this", "Let's explore", "Let's dive in".
...
Fix: Just present the analysis. Readers don't need permission to follow along.

## Vague Attributions

Attributing claims to unnamed authorities instead of being specific. AI invokes "experts", "observers", "industry reports" without naming anyone. It also inflates quantity — presenting what one person said as a widely held view.
...
Fix: Name the source or drop the attribution. "A 2024 Gartner report found..." or just state the claim directly.

## Invented Concept Labels

AI clusters invented compound labels that sound analytical without being grounded. It appends abstract problem-nouns (paradox, trap, creep, divide, vacuum, inversion) to domain words and uses them as if they're established terms. They function as rhetorical shorthand: name a thing, skip the argument. Multiple such labels in the same piece is a strong AI signal.
...
Fix: Describe the phenomenon instead of labeling it. If the label isn't established in the field, don't pretend it is.
