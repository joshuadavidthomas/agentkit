...
Fix: Use commas, parentheses, or separate sentences. Reserve em dashes for the one or two places where they genuinely earn their keep.

## Bold-First Bullets

Every bullet point or list item starts with a bolded phrase or sentence. Common in Claude and ChatGPT markdown output. Almost nobody formats lists this way when writing by hand. A telltale sign of AI-generated documentation and blog posts.

Bad:
- "**Security**: Environment-based configuration with..."
- "**Performance**: Lazy loading of expensive resources..."

Fix: Write list items as normal sentences. If the list needs headings, use actual headings.
...
Fix: Use `->`, `=>`, or just write "leads to". Use straight quotes.
