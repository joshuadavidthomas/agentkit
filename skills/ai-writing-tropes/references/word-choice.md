...
Also includes: "deeply", "fundamentally", "remarkably", "arguably".
...
Also includes: "certainly", "utilize", "leverage" (as a verb), "robust", "streamline", "harness".
...
Ornate or grandiose nouns where simpler words work. "Tapestry" for anything interconnected. "Landscape" for any field or domain.

Also includes: "paradigm", "synergy", "ecosystem", "framework".
...
Fix: Say what you mean. "The field of AI" or just "AI". "How things connect" instead of "tapestry".

## The "Serves As" Dodge

Replacing simple "is" or "are" with pompous alternatives. AI avoids basic copulas because its repetition penalty pushes it toward fancier constructions.

Also includes: "stands as", "marks", "represents".
...
Fix: Use "is". "The building is a reminder of the city's heritage." Shorter, clearer, better.
