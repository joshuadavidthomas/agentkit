...
- Project: `.agents/research/`
- Global: `~/.agents/research/`
...
| Location | Use For |
|----------|---------|
| `.agents/research/` | Project-specific research (may be committed or gitignored) |
| `~/.agents/research/` | Cross-project knowledge, general patterns |
