...
- [x] Create `skills/jj-history/references/conflicts.md` from canonical docs
- [x] Create `skills/jj-history/references/divergence.md` from canonical docs
- [x] Write `skills/jj-history/SKILL.md` (~300 lines)
- [x] Write `skills/jj-history/README.md` with attribution
