---
description: code-pattern-finder is a useful subagent for finding similar
  ...
  for! It's sorta like code-locator, but it will not only tell you the location
  of files, it will also give you code details!
